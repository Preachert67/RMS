   ...
   (
       ...
       int nHeightEllipse // height of ellipse
        ...
        public frmDashboard()
        {
            ...
            //user ID passing from Login

            lblUserID.Text = frmLogin.SetValueForText1;
       ...
       //=====================================Dashboard connecting to template========================================= 
        ...
        {
            PanelDesktop.Controls.Clear();
           frmPayment formFeedback = new frmPayment();
        ...
        private void btnTileMenu_Click(object sender, EventArgs e)
        {
            ...
            PanelDesktop.Controls.Add(formMenu);
        ...
        private void btnTilePaymentSlip_Click(object sender, EventArgs e)
        {
            PanelDesktop.Controls.Clear();
            frmPayment formPayment = new frmPayment();
            formPayment.TopLevel = false;
            PanelDesktop.Controls.Add(formPayment);
            formPayment.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
